"use strict";
function Empolyee(config) {
    var newEmployee = { fistName: "Default firstname", lastName: "Default lastName", employeeId: 11111, age: 0, saraly: 20000, bonus: true };
    if (config.fistName) {
...
var myEmployee = Empolyee({ fistName: "Atikan", lastName: "Kannang", employeeId: 622110340, age: 23, salary: 15000, bonus: true });
